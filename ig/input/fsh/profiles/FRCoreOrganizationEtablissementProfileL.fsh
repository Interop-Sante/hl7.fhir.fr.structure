Profile: FRCoreOrganizationEtablissementProfileL
Parent: FRCoreOrganizationProfileL
Id: fr-core-organization-etablissement-wlist
Title: "FR Core Organization Etablissement Profile (List)"
