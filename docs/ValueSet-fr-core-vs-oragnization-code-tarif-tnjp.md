# FR Core ValueSet Codes Tarifs - nomenclature TNJP - Guide d'implémentation Fr Core v2.1.0
...
| | |
| :--- | :--- |
| *Official URL*:https://hl7.fr/ig/fhir/core/ValueSet/fr-core-vs-oragnization-code-tarif-tnjp | *Version*:2.1.0 |
...
* Include tous les codes définis dans [`https://hl7.fr/ig/fhir/core/CodeSystem/fr-core-cs-code-tarif-tnjp`](CodeSystem-fr-core-cs-code-tarif-tnjp.md)version 📦2.1.0
