# FR Core ValueSet Location Position Lit - Guide d'implémentation Fr Core v2.1.0
...
| | |
| :--- | :--- |
| *Official URL*:https://hl7.fr/ig/fhir/core/ValueSet/fr-core-vs-location-position-lit | *Version*:2.1.0 |
...
* Include tous les codes définis dans [`https://hl7.fr/ig/fhir/core/CodeSystem/fr-core-cs-location-position-lit`](CodeSystem-fr-core-cs-location-position-lit.md)version 📦2.1.0
