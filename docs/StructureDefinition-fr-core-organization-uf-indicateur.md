# FR Core Organization Extension - Indicateur d'une unité fonctionnelle - Guide d'implémentation Fr Core v2.1.0
...
| | |
| :--- | :--- |
| *Official URL*:https://hl7.fr/ig/fhir/core/StructureDefinition/fr-core-organization-uf-indicateur | *Version*:2.1.0 |
