# FR Core ValueSet Organization Discipline de prestation - nomenclature SAE - Guide d'implémentation Fr Core v2.1.0
...
| | |
| :--- | :--- |
| *Official URL*:https://hl7.fr/ig/fhir/core/ValueSet/fr-core-vs-discipline-prestation | *Version*:2.1.0 |
| Active as of 2025-11-02 | *Computable Name*:FRCoreValueSetDisciplinePrestation |
...
* Include tous les codes définis dans [`https://hl7.fr/ig/fhir/core/CodeSystem/fr-core-cs-discipline-prestation`](CodeSystem-fr-core-cs-discipline-prestation.md)version 📦2.1.0
