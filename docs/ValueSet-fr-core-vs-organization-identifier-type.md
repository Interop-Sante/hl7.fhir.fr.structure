# FR Core ValueSet Organization identifier type - Guide d'implémentation Fr Core v2.1.0
...
| | |
| :--- | :--- |
| *Official URL*:https://hl7.fr/ig/fhir/core/ValueSet/fr-core-vs-organization-identifier-type | *Version*:2.1.0 |
| Active as of 2025-11-02 | *Computable Name*:FRCoreValueSetOrganizationIdentifierType |
...
* Include ce(s) code(s) tel quil(s) est (sont) défini(s) dans `https://hl7.fr/ig/fhir/core/CodeSystem/fr-core-cs-v2-0203`version Not Stated (use latest from terminology server)
