# FR Core Organization Profile - Guide d'implémentation Fr Core v2.1.0
...
| | |
| :--- | :--- |
| *Official URL*:https://hl7.fr/ig/fhir/core/StructureDefinition/fr-core-organization | *Version*:2.1.0 |
| Active as of 2025-11-02 | *Computable Name*:FRCoreOrganizationProfile |
...
* Derived from this Profile: [FR Core Organization Etablissement Profile](StructureDefinition-fr-core-organization-etablissement.md), [FR Core Organization UAC Profile](StructureDefinition-fr-core-organization-uac.md) and [FR Core Organization UF Profile](StructureDefinition-fr-core-organization-uf.md)
* Refer to this Profile: [FR Core Organization Extension - Membre d'organisation](StructureDefinition-fr-core-organization-member.md) and [FR Core Organization Profile](StructureDefinition-fr-core-organization.md)
* Examples for this Profile: [Depertement d'Endocrinologie](Organization-hopitaltest-dept-11003-endocrino.md), [Pole Medecines spécialisées](Organization-hopitaltest-pole-1150-med-spe.md), [Service Endocrino Diabeto](Organization-hopitaltest-service-11006-endocrino-diabo.md) and [Service Dietetique](Organization-hopitaltest-service-11007-dietetique.md)
        ...
        "type" : [
          {
            "code" : "Extension",
            "profile" : [
              "http://example.org/fhir/StructureDefinition/organization-member"
            ]
          }
        ]
      },
