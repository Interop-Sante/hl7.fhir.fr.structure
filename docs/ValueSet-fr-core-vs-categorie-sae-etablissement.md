# FR Core ValueSet Categorie SAE Etablissement - Guide d'implémentation Fr Core v2.1.0
...
| | |
| :--- | :--- |
| *Official URL*:https://hl7.fr/ig/fhir/core/ValueSet/fr-core-vs-categorie-sae-etablissement | *Version*:2.1.0 |
