# FR Core Location Extension - Type de chambre - Guide d'implémentation Fr Core v2.1.0
...
| | |
| :--- | :--- |
| *Official URL*:https://hl7.fr/ig/fhir/core/StructureDefinition/fr-core-location-type-chambre | *Version*:2.1.0 |
| Active as of 2025-11-02 | *Computable Name*:FRCoreLocationTypeChambreExtension |
  ...
  "differential" : {
    "element" : [
      ...
      },
      {
        ...
        "binding" : {
          "strength" : "extensible",
          "valueSet" : "https://hl7.fr/ig/fhir/core/ValueSet/fr-core-vs-location-type-chambre"
        }
      }
    ]
  }
