# FR Core ValueSet INSEE code - Guide d'implémentation Fr Core v2.1.0
...
| | |
| :--- | :--- |
| *Official URL*:https://hl7.fr/ig/fhir/core/ValueSet/fr-core-vs-insee-code | *Version*:2.1.0 |
| Active as of 2025-11-02 | *Computable Name*:FRCoreValueSetINSEECode |
| *Other Identifiers:*http://interopsante.org/fhir/ValueSet#urn:oid:2.16.840.1.113883.2.8.1.3.4 | |
...
* Include tous les codes définis dans `https://mos.esante.gouv.fr/NOS/TRE_R13-CommuneOM/FHIR/TRE-R13-CommuneOM`version Not Stated (use latest from terminology server)

 

### Expansion

Expansion from smt.esante.gouv.fr based on system TRE-R13-CommuneOM version 20240628120000
