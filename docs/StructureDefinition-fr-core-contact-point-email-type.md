# FR Core Contact Point Email Type Extension - Guide d'implémentation Fr Core v2.1.0
...
| | |
| :--- | :--- |
| *Official URL*:https://hl7.fr/ig/fhir/core/StructureDefinition/fr-core-contact-point-email-type | *Version*:2.1.0 |
| Active as of 2025-11-02 | *Computable Name*:FRCoreContactPointEmailTypeExtension |
