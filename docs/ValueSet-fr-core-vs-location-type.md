# FR Core ValueSet Location type - Guide d'implémentation Fr Core v2.1.0
...
| | |
| :--- | :--- |
| *Official URL*:https://hl7.fr/ig/fhir/core/ValueSet/fr-core-vs-location-type | *Version*:2.1.0 |
...
* Include tous les codes définis dans [`https://hl7.fr/ig/fhir/core/CodeSystem/fr-core-cs-location-type`](CodeSystem-fr-core-cs-location-type.md)version 📦2.1.0
