# FR Core ValueSet Organization Champ Activite - Champ d'activité clinique de l'organisation type UF - Guide d'implémentation Fr Core v2.1.0
...
| | |
| :--- | :--- |
| *Official URL*:https://hl7.fr/ig/fhir/core/ValueSet/fr-core-vs-organization-champ-activite | *Version*:2.1.0 |
...
* Include tous les codes définis dans [`https://hl7.fr/ig/fhir/core/CodeSystem/fr-core-cs-champ-activite`](CodeSystem-fr-core-cs-champ-activite.md)version 📦2.1.0
