# FR Core Organization Extension - Nombre total de places d'hébergement théoriques - Guide d'implémentation Fr Core v2.1.0
...
| | |
| :--- | :--- |
| *Official URL*:https://hl7.fr/ig/fhir/core/StructureDefinition/fr-core-organization-place-hebergement-theorique | *Version*:2.1.0 |
| Active as of 2025-11-02 | *Computable Name*:FRCoreOrganizationPlaceHebergementTheoriqueExtension |
