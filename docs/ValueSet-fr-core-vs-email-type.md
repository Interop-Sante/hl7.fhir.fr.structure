# FR Core ValueSet Email type - Guide d'implémentation Fr Core v2.1.0
...
| | | |
| :--- | :--- | :--- |
| *Official URL*:https://hl7.fr/ig/fhir/core/ValueSet/fr-core-vs-email-type | *Version*:2.1.0 | |
...
* Include tous les codes définis dans [`https://mos.esante.gouv.fr/NOS/TRE_R256-TypeMessagerie/FHIR/TRE-R256-TypeMessagerie`](https://interop.esante.gouv.fr/ig/nos/1.3.0/CodeSystem-TRE-R256-TypeMessagerie.html)version 📦1.3.0
